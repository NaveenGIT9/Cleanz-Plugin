...
[![NPM](https://img.shields.io/npm/v/@salesforce/plugin-cleanz.svg?label=@salesforce/plugin-cleanz)](https://www.npmjs.com/package/@salesforce/plugin-cleanz) [![Downloads/week](https://img.shields.io/npm/dw/@salesforce/plugin-cleanz.svg)](https://npmjs.org/package/@salesforce/plugin-cleanz) [![License](https://img.shields.io/badge/License-Apache--2.0-blue.svg)](https://opensource.org/license/apache-2-0)
...
```bash
sf plugins install @salesforce/plugin-cleanz@x.y.z
```
...
git clone git@github.com:salesforcecli/plugin-cleanz
...
_See code: [src/commands/cleanz/run.ts](https://github.com/salesforcecli/plugin-cleanz/blob/v1.0.3/src/commands/cleanz/run.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/salesforcecli/plugin-cleanz/blob/v1.0.3/src/commands/hello/world.ts)_
...
_See code: [src/commands/cleanz/run.ts](https://github.com/salesforcecli/plugin-cleanz/blob/v1.0.2/src/commands/cleanz/run.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/salesforcecli/plugin-cleanz/blob/v1.0.2/src/commands/hello/world.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/salesforcecli/plugin-cleanz/blob/1.1.76/src/commands/hello/world.ts)_
